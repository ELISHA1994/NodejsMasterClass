...
// Look up all the checks, gather thier data, send to a validator
            ...
            checks.forEach(function(check){
                ...
                _data.read('checks',check,function(err,originalCheckData){
                    if (!err && originalCheckData) {
                        // Pass it to the checks validator, and let that function continue or log errors as needed
...
// Perform the check, send the originalCheckData and the out come of the check process, to the next step in the process
...
// Special logic for accommodating a check that has never been tested before, we dont want to alert on that one
